...
Andy (55), annual income = $60,000, 401k = $125,000
          ...
          { showSplash && (
            <div className="welcome">
              ...
              <div className="banner">
                <div className="tagline">Hi! I'm Friday, your Virtual AI Assistant...</div>
                <div>Talk to me just like you'd talk to a 
                  real person. I can use all the tools and data that you can and I'm ready 
                  to help! Where do you want to start?</div>
              </div>
              <div className="starters">

                <div className="starter" onClick={virtualAssistant}>
                  <div className="starter-text">Let's Just Chat!</div>
                  <div className='img-container'><img src='../../pointer.png' width="16" height="16"></img></div>
                </div>

                <div className="starter" onClick={listen}>
                  <div className="starter-text">Listen in on a Call</div>
                  <div className='img-container'><img src='../../pointer.png' width="16" height="16"></img></div>
                </div>

                <div className="starter" onClick={coach}>
                  <div className="starter-text">Coaching Role Play</div>
                  <div className='img-container'><img src='../../pointer.png' width="16" height="16"></img></div>
                </div>
              
                <div className="starter" onClick={toolUseDemo}>
                  <div className="starter-text">Tool Use Demo</div>
                  <div className='img-container'><img src='../../pointer.png' width="16" height="16"></img></div>
                </div>
